...
# Slightly widened the account column to fit the custom name greeting
...
with tab_home:
    ...
    if go:
        with st.spinner("Analysing patterns & fetching posters…"):
            ...
            # Pre-fetch posters so the UI doesn't freeze/load a second time while rendering
            for r in recs:
